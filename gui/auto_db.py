...
def auto(self, extract_path) :
    try :
        ...
        try :
            ...
            conn.commit()
            conn.close()
            print("[AUTO] Apple Account Artifacts Analyze Success")
        ...
        try :
            ...
            conn.commit()
            conn.close()
            print("[AUTO] Sim Card Artifacts Analyze Success")
        ...
        try :
            ...
            conn.commit()
            conn.close()
            print("[AUTO] Bluetooth Artifacts Analyze Success")
        ...
        try :
            ...
            conn.commit()
            conn.close()
            print("[AUTO] Bluetooth devices that have been shown Artifact Analyze Success")
        ...
        try :
            ...
            conn.commit()
            conn.close()
            print("[AUTO] App Permision (TCC) Artifact Analyze Success")
        ...
        try :
            ...
            conn.commit()
            conn.close()
            print("[AUTO] Wallet Pass Artifact Analyze Success")
        ...
        try :
            ...
            conn.commit()
            conn.close()
            print("[AUTO] Owner Information Artifact Analyze Success")
        ...
        try :
            ...
            conn.commit()
            conn.close()
            print("[AUTO] Calendar Event Artifact Analyze Success")
        ...
        try :
            ...
            conn.commit()
            conn.close()
            print("[AUTO] Address Book Artifact Analyze Success")
        ...
        try :
            ...
            conn.commit()
            conn.close()
            print("[AUTO] Install Application Artifact Analyze Success")
        ...
        try :
            ...
            conn.commit()
            conn.close()
            print("[AUTO] SMS Artifact Analyze Success")
